...
let transactionId2;
async function generateKey(description) {

  const url = 'https://backend-idempotency-provider.greenplant-9a54dc56.germanywestcentral.azurecontainerapps.io/generate-key/?description=' + description;
...
function generateOutputEditFilm() {
  ...
  // ier
  const filmInfo4 = `https://dsssi-backend-lookup.greenplant-9a54dc56.germanywestcentral.azurecontainerapps.io/filmBearbeiten?titel=${titel12}&genre=${genre12}&fsk=${fsk12}&dauer=${dauer12}&erwachsen=${erwachsene12}&ermaessigt=${ermassigt12}&kinder=${kinder12}&kategorie=${kategorie12}&beschreibung=${filminfo12}&trailerURL=${html12}&transID=${transID}`
